-- ============================================================
-- Migration 024: пробросить platform в creative_performance
--
-- Данные размечены по platform ('meta' | 'google' | 'tiktok') в meta_ads, но view
-- не отдавал эту колонку → нельзя фильтровать статистику по каналу. Добавляем
-- platform в meta_agg и в финальный select. Остальное идентично миграции 023
-- (pbi_agg учитывает elly:% и google:%).
-- ============================================================
